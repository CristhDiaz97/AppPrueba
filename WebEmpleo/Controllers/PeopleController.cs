...
namespace WebEmpleo.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var Experiencia = _context.Experiencias.ToList();
            ViewBag.Experiencia = Experiencia;            
            return View(await dbPruebaContext.ToListAsync());
        }

        // GET: Experiencias
        //public async Task<PartialViewResult> IndexExpeciencia()
        //{
        //    if (!User.Identity.IsAuthenticated)
        //    {
        //        return Redirect("/Home/Error");
        ...
        //    return PartialView(_partialExperiencia);
        //}
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            IEnumerable<Experiencia> resp = _context.Experiencias.Where(x => x.IdPersona == id).ToList() as IEnumerable<Experiencia>;
            ViewData["Experiencias"] = resp;
            ViewData["IdNivelEducativo"] = new SelectList(_context.NivelesEducativos, "IdNivelEducativo", "Descripcion", person.IdNivelEducativo);
            return View(person);
        }
